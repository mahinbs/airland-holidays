...
export default function Navbar() {
    ...
    const isRouteActive = (item: typeof navStructure[0]) => {
                        ...
                        <div className="hidden lg:flex items-center gap-6 xl:gap-8">
                                                ...
                                                {item.type === 'link' ? (
                                                    <a
                                                        ...
                                                        className={clsx(
                                                            ...
                                                            isActive || isHovered ? 'text-primary' : 'text-slate-950 hover:text-primary'
                                                        )}
                                                    >
                                                        {item.label}
                                                        {(isActive || isHovered) && (
                            ...
                            <div className="flex items-center gap-4 pl-6 border-l border-slate-200">
                                <button
                                    ...
                                    className="text-slate-950 hover:text-primary transition-colors"
                                    aria-label="Search"
                                >
                                ...
                                <a
                                    href="/contact"
                                    className="bg-primary hover:bg-primary-dark text-white font-black text-xs md:text-sm px-5 md:px-6 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex items-center gap-2 uppercase tracking-wider"
                                >
                                                    ...
                                                    >
                                                        {item.type === 'mega' && item.tabs?.map(tab => (
                                                            <div key={tab.id}>
                                                                <button
                                                                    ...
                                                                    className="w-full flex items-center justify-between pl-4 py-3 text-slate-950 text-sm border-b border-slate-50 font-semibold"
                                                                >
                                                                    {tab.label}
                                                                                            ...
                                                                                            >
                                                                                                {col.destinations.map(dest => (
                                                                                                    <button
                                                                                                        ...
                                                                                                        className="text-left pl-12 py-2.5 text-slate-950 text-sm hover:text-primary transition-colors"
                                                                                                    >
                                                                                                        {dest}
                                                                                                    </button>
                                                                                                ))}
                                                        ...
                                                        {item.type === 'dropdown' && item.items?.map(subItem => (
                                                            <a
                                                                key={subItem.label}
                                                                href={subItem.href}
                                                                className="block pl-4 py-3 text-slate-950 text-sm border-b border-slate-50 hover:text-primary transition-colors"
                                                                onClick={() => setIsMobileMenuOpen(false)}
                                                            >
                                                                {subItem.label}
                                                            </a>
