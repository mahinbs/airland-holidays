            ...
            <div className="p-6 md:p-8 bg-white">
                <form onSubmit={handleCapture} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input required type="text" readOnly value={data?.destination} className="w-full px-4 py-2.5 rounded-xl bg-slate-100 border border-slate-200 text-slate-500 text-sm font-bold opacity-80 cursor-not-allowed" />
                    </div>
